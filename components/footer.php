<footer class="footer">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 block__newsletter">
        <h2>NEWSLETTER SIGN UP</h2>
        <div class="footer-block__subheading">
          Sign up for exclusive updates, new arrivals &amp; insider only discounts
        </div>
        <form action="" class="d-flex">
          <input type="email" class="field__input" placeholder="enter your email address">
...
<div class="footer__content-bottom">
  <div class="container">
    <div class="row">
      <div class="align-items-center col-md-4 d-flex">
        <div class="copyright">
          Gympros. All Rights Reserved
        </div>
      </div>
      <div class="col-md-6 ms-auto">
        <div class="accept-payment text-end">
