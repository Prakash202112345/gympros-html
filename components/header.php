...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9">
                        <ul class="menu1-right">
                            ...
                            <li><a href="#">Commercial Gym Packages</a></li>
    ...
    C482,254.358,413.255,312.939,309.193,401.614z"></path>
                                        ...
                                        <span class="cart-text">My Wish List</span>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="menu3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 menu1-right ms-auto">
                ...
                <div class="px-0">
                    <div class="align-items-center d-flex justify-content-between">
                        <div><button class="navbar-toggler" type="button" data-bs-toggle="offcanvas"
                            ...
                            <a class="navbar-brand" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><a href=""> <img src="./assets/logo-gympros-1.jpeg" alt="logo" class="img-fluid logo"></a></h5>
